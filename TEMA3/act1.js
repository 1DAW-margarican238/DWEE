"use strict"
{
   function guardarElColor () { 
        ...
        if (cookieColor != ""){
            ...
            let rojo;
            do {
                rojo = prompt("Introduce el color rojo: (1-255)");
            }while(rojo < 1 || rojo > 255 || isNaN(rojo));

            let verde;
            do {
                verde = prompt("Introduce el color verde: (1-255)");
            }while(verde < 1 || verde > 255 || isNaN(verde));

            let azul;
            do {
                azul = prompt("Introduce el color azul: (1-255)");
            }while(azul < 1 || azul > 255 || isNaN(azul));
            
            let rgb = "rgb(" + rojo + ", " + verde + ", " + azul + ")";
            setCookie("color", rgb);
